...
export const HERO_SLIDES: HeroSlide[] = [
  {
    ...
    description: "Transform hospitality spaces with premium hotel furniture designed for luxury, comfort, and lasting performance. From guest rooms to lobby areas, we create custom solutions for hotels and resorts worldwide.",
    image: "/images/hotel_lobby_furniture.png",
    primaryLink: "/category/hotel-furniture",
    primaryText: "Explore Hotel Series",
    secondaryLink: "/contact",
    secondaryText: "Bespoke Consultation",
  },
  {
    id: "hero-cafe",
    title: "Designed for Memorable\nCafé Experiences",
    subtitle: "Café Furniture Supplier & Exporter",
    description: "Create inviting café interiors with handcrafted furniture that blends comfort, durability, and contemporary design. Ideal for cafés, coffee shops, bakeries, and casual dining spaces.",
    image: "/images/cafe_patio_chairs.png",
    primaryLink: "/category/cafe-furniture",
    primaryText: "Explore Café Series",
    secondaryLink: "/contact",
  ...
  },
  {
    ...
    subtitle: "Bar & Restaurant Furniture Supplier & Exporter",
    description: "Discover stylish and durable furniture crafted for restaurants, bars, lounges, and hospitality venues. Designed to withstand everyday use while enhancing your interior aesthetics.",
    image: "/images/restaurant_dining_tables.png",
    primaryLink: "/category/restaurant-furniture",
    primaryText: "Explore Restaurant Series",
    secondaryLink: "/contact",
  ...
  },
  {
    ...
    secondaryLink: "/contact",
    secondaryText: "Commission Project",
  },
];
