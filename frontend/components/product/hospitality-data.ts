...
export const INDIAN_HOSPITALITY_PRODUCTS: HospitalityProduct[] = [
  ...
  },
  {
    ...
    subcategory: "Bone Inlay Cabinets",
  ...
  },
  {
    ...
    subcategory: "Hotel Bedroom Furniture",
  ...
  },
  {
    ...
    category: "Restaurant Furniture",
    subcategory: "Restaurant Dining Tables",
  ...
  },
  {
    ...
    category: "Bone Inlay Furniture",
    subcategory: "Bone Inlay Console Tables",
  ...
  {
    id: "ind-thar-rope-chair",
    title: "Thar Desert Handwoven Rope Dining Chair",
    name: "Thar Desert Handwoven Rope Dining Chair",
    slug: "thar-desert-handwoven-rope-dining-chair",
    category: "Rope Furniture",
    subcategory: "Rope Chairs",
    description: "Sleek dining chair weaving high-tensile coir ropes over a reclaimed teak frame.",
    story: "Handcrafted in Jodhpur, this dining chair marries modern clean lines with traditional desert weaving techniques. Tensioned coir ropes form an ergonomic, breathable seat, while the frame is sculpted from organic reclaimed teakwood.",
    designer: "Jodhpur Woodworking Atelier",
    materials: ["Reclaimed Teakwood", "Natural Coir Rope"],
    dimensions: { height: 85, width: 50, depth: 52, unit: "cm" },
    finishes: ["Natural Teak Wax", "Ebonized Charcoal Matte"],
    price: "₹18,500",
    image: "https://images.unsplash.com/photo-1507473885765-e6ed057f782c?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1507473885765-e6ed057f782c?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Boutique restaurant dining rooms, hotel breakfast alcoves, and resort dining patios.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["rope", "chair", "dining", "seating", "jodhpur"]
  },
  {
    id: "ind-malabar-rope-sofa",
    title: "Malabar Coastal Organic Rope Sofa",
    name: "Malabar Coastal Organic Rope Sofa",
    slug: "malabar-coastal-organic-rope-sofa",
    category: "Rope Furniture",
    subcategory: "Rope Sofas",
    description: "An elegant, low-profile two-seater sofa featuring high-tensile organic jute rope backing.",
    story: "Bring coastal elegance to lounges and lobbies. The Malabar sofa features hand-tensioned dyed organic jute cords wrapped across a sturdy solid rosewood frame, paired with deep-sink canvas cushioning.",
    designer: "Kerala Craft Conservatory",
    ...
    finishes: ["Natural Matte Rosewood Wax", "Warm Honey Amber"],
    price: "₹54,000",
    image: "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Hotel lobby lounge spaces, boutique resort reception areas, and luxury suite sitting rooms.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["rope", "sofa", "lounge", "seating", "malabar"]
  },
  {
    id: "ind-goa-outdoor-lounger",
    title: "Goa Resort Weatherproof Outdoor Rope Lounger",
    name: "Goa Resort Weatherproof Outdoor Rope Lounger",
    slug: "goa-resort-weatherproof-outdoor-rope-lounger",
    category: "Rope Furniture",
    subcategory: "Outdoor Rope Furniture",
    description: "A reclining outdoor lounger crafted from powder-coated aluminum and UV-resistant polyester rope.",
    story: "Designed for ultimate poolside comfort. The Goa lounger weaves high-grade, UV-treated polyester rope over a rust-proof aluminum frame, making it fully weatherproof and highly durable for tropical resort settings.",
    designer: "SB Artisan Atelier",
    ...
    finishes: ["Sandstone Grey", "Charcoal Black"],
    price: "₹32,500",
    image: "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Hotel poolside cabanas, open-air beach club terraces, and resort balconies.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["rope", "outdoor", "lounger", "patio", "resort", "goa"]
  },
  {
    id: "ind-hotel-lounge-chair",
    title: "Amanbagh Palace Teak Lobby Lounge Chair",
    name: "Amanbagh Palace Teak Lobby Lounge Chair",
    slug: "amanbagh-palace-teak-lobby-lounge-chair",
    category: "Hotel Furniture",
    subcategory: "Hotel Chairs",
    description: "Low-slung, premium lobby lounge chair sculpted from seasoned teak with woven cane back.",
    story: "Designed for premium hotel lobby lounges and suites, this low-slung chair features solid, hand-planed teakwood frames and double-woven rattan cane backing for breathable comfort.",
    designer: "Jodhpur Woodworking Atelier",
    materials: ["Plantation Teakwood", "Natural Rattan Cane"],
    dimensions: { height: 74, width: 78, depth: 80, unit: "cm" },
    finishes: ["Honey Amber Polish", "Smoked Charcoal Matte Oil"],
    price: "₹36,000",
    image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Hotel lobby lounge zones, executive suite sitting areas, and resort veranda reading spots.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["hotel", "chair", "lounge", "seating", "teak", "cane"]
  },
  {
    id: "ind-hotel-dining-table",
    title: "Udaipur Palace Carved Hotel Dining Table",
    name: "Udaipur Palace Carved Hotel Dining Table",
    slug: "udaipur-palace-carved-hotel-dining-table",
    category: "Hotel Furniture",
    subcategory: "Hotel Dining Tables",
    description: "An opulent, hand-carved rectangular hotel dining table made of premium solid rosewood.",
    story: "Bring the majestic heritage of Udaipur palaces to hotel dining rooms. Carved from seasoned Sheesham wood with brass inlays and traditional fluted legs.",
    designer: "Udaipur Woodworking Atelier",
    materials: ["Solid Sheesham Wood", "Brass Details"],
    dimensions: { height: 76, width: 220, depth: 100, unit: "cm" },
    finishes: ["Warm Rosewood Wax", "Ebonized Walnut Polish"],
    price: "₹92,000",
    image: "https://images.unsplash.com/photo-1615066390971-03e4e1c36ddf?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1615066390971-03e4e1c36ddf?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Hotel private dining rooms, banqueting VIP halls, and executive resort suites.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["hotel", "table", "dining", "sheesham", "palace"]
  },
  {
    id: "ind-hotel-sofa",
    title: "Rajputana Velvet Chesterfield Hotel Sofa",
    name: "Rajputana Velvet Chesterfield Hotel Sofa",
    slug: "rajputana-velvet-chesterfield-hotel-sofa",
    category: "Hotel Furniture",
    subcategory: "Hotel Sofas",
    description: "A deep-buttoned chesterfield hotel lounge sofa upholstered in premium organic cotton velvet.",
    story: "Handcrafted in Jodhpur, this classical deep-tufted chesterfield sofa features soft velvet upholstery over a reinforced solid wood frame with turned brass-capped legs.",
    designer: "Jodhpur Woodworking Atelier",
    materials: ["Solid Teak Frame", "Cotton Velvet", "Brass Casters"],
    dimensions: { height: 80, width: 210, depth: 90, unit: "cm" },
    finishes: ["Royal Indigo Blue", "Emerald Forest Green"],
    price: "₹72,000",
    image: "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Boutique hotel lobby reception, executive suite lounge spaces, and club membership salons.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["hotel", "sofa", "lounge", "seating", "velvet"]
  },
  {
    id: "ind-hotel-outdoor-lounger",
    title: "Goa Resort Weatherproof Rattan Hotel Pool Lounger",
    name: "Goa Resort Weatherproof Rattan Hotel Pool Lounger",
    slug: "goa-resort-weatherproof-rattan-hotel-pool-lounger",
    category: "Hotel Furniture",
    subcategory: "Outdoor Hotel Furniture",
    description: "An adjustable outdoor lounger featuring weather-resistant wicker rattan and quick-dry cushioning.",
    story: "Designed for intensive resort pool use, this lounger features a rust-proof aluminum sub-frame hand-wrapped in synthetic, UV-treated wicker rattan with a multi-angle reclining backrest.",
    designer: "SB Artisan Atelier",
    ...
    finishes: ["Nude Sand Wicker", "Charcoal Wicker"],
    price: "₹28,500",
    image: "https://images.unsplash.com/photo-1592078615290-033ee584e267?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1592078615290-033ee584e267?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Hotel outdoor swimming pools, beachside cabanas, open-air sun terraces.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["hotel", "outdoor", "lounger", "pool", "rattan", "resort"]
  },
  {
    id: "ind-restaurant-booth",
    title: "Haveli Leather Upholstered Booth Seating",
    name: "Haveli Leather Upholstered Booth Seating",
    slug: "haveli-leather-upholstered-booth-seating",
    category: "Restaurant Furniture",
    subcategory: "Restaurant Booth Seating",
    description: "Modular contract booth seating upholstered in premium full-grain Indian leather with a teak base.",
    story: "Created for high-end dining privacy. The Haveli Booth Seating features premium fluted leather upholstery with a sturdy plantation teak plinth base and ergonomic comfort.",
    designer: "Jodhpur Woodworking Atelier",
    materials: ["Plantation Teakwood", "Full-grain Indian Leather"],
    dimensions: { height: 95, width: 150, depth: 70, unit: "cm" },
    finishes: ["Saddle Brown", "Onyx Black", "Forest Green"],
    price: "₹65,000",
    image: "https://images.unsplash.com/photo-1503602642458-232111445657?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1503602642458-232111445657?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Boutique restaurants, hotel dining rooms, VIP lounge areas.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["restaurant", "booth", "seating", "leather", "teak"]
  },
  {
    id: "ind-restaurant-bench",
    title: "Shekhawati Reclaimed Teak Dining Bench",
    name: "Shekhawati Reclaimed Teak Dining Bench",
    slug: "shekhawati-reclaimed-teak-dining-bench",
    category: "Restaurant Furniture",
    subcategory: "Restaurant Benches",
    description: "A solid, hand-planed dining bench crafted from century-old reclaimed haveli teak timbers.",
    story: "Handcrafted from structural haveli beams. This dining bench emphasizes traditional joinery and seasoned golden grains, offering group dining functionality with timeless rustic style.",
    designer: "Jodhpur Woodworking Atelier",
    materials: ["Reclaimed Teakwood"],
    dimensions: { height: 46, width: 160, depth: 40, unit: "cm" },
    finishes: ["Natural Aged Teak Wax", "Honey Amber Polish"],
    price: "₹28,000",
    image: "https://images.unsplash.com/photo-1503602642458-232111445657?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1503602642458-232111445657?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Casual group dining tables, rustic cafes, and hotel restaurant waiting areas.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["restaurant", "bench", "dining", "seating", "teak"]
  },
  {
    id: "ind-restaurant-outdoor",
    title: "Thar Desert Weatherproof Restaurant Dining Set",
    name: "Thar Desert Weatherproof Restaurant Dining Set",
    ...
    story: "Designed for open-air hotel terraces. Made of weather-treated, marine-grade plantation teak with rust-proof stainless steel fittings.",
    designer: "SB Artisan Atelier",
    materials: ["Plantation Teakwood", "Synthetic Wicker"],
    dimensions: { height: 75, width: 140, depth: 80, unit: "cm" },
    finishes: ["Natural Weatherproof Teak Oil"],
    price: "₹88,000",
    image: "https://images.unsplash.com/photo-1592078615290-033ee584e267?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1592078615290-033ee584e267?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Hotel rooftop dining, open-air restaurant terraces, beach resort patios.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["restaurant", "outdoor", "dining", "teak", "patio"]
  },
  {
    id: "ind-restaurant-custom",
    title: "Bespoke Jodhpur Live Edge Restaurant Table",
    name: "Bespoke Jodhpur Live Edge Restaurant Table",
    ...
    story: "Celebrate organic silhouettes. This custom table top is finished with a B2B contract-grade, acid-resistant matte lacquer and mounted on heavy industrial steel legs.",
    designer: "Jodhpur Woodworking Atelier",
    materials: ["Acacia Wood", "Industrial Steel Legs"],
    dimensions: { height: 76, width: 200, depth: 90, unit: "cm" },
    finishes: ["Natural Acacia Wax", "Charcoal Shou Sugi Ban"],
    price: "₹76,000",
    image: "https://images.unsplash.com/photo-1615066390971-03e4e1c36ddf?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1615066390971-03e4e1c36ddf?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Signature restaurant main tables, boutique café centerpieces, executive hotel boardrooms.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["restaurant", "table", "custom", "acacia", "live edge"]
  },
  {
    id: "ind-bar-chair",
    title: "Atelier Teakwood High Bar Chair",
    name: "Atelier Teakwood High Bar Chair",
    slug: "atelier-teakwood-high-bar-chair",
    category: "Bar Furniture",
    subcategory: "Bar Chairs",
    description: "Sleek, high-profile bar seating crafted from seasoned teakwood and premium leather.",
    story: "Designed for luxury hospitality lounges. Features a hand-sanded teak frame, curved support backrest, and brass metal footrest protector.",
    designer: "Jodhpur Woodworking Atelier",
    materials: ["Plantation Teakwood", "Premium Leather", "Brass Hardware"],
    dimensions: { height: 104, width: 48, depth: 50, unit: "cm" },
    finishes: ["Honey Amber Polish", "Natural Aged Teak Wax"],
    price: "₹22,500",
    image: "https://images.unsplash.com/photo-1507473885765-e6ed057f782c?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1507473885765-e6ed057f782c?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Boutique hotel cocktail lounges, pub bar counters, and high-end restaurant bars.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["bar", "chair", "seating", "teak", "leather"]
  },
  {
    id: "ind-bar-table",
    title: "Jodhpur Industrial Steel & Wood Bar Table",
    name: "Jodhpur Industrial Steel & Wood Bar Table",
    ...
    story: "Built to endure active commercial use. Handcrafted in Jodhpur with a raw metal base and deep distressed golden mango wood top.",
    designer: "Jodhpur Woodworking Atelier",
    materials: ["Solid Mango Wood", "Industrial Steel Base"],
    dimensions: { height: 105, width: 120, depth: 60, unit: "cm" },
    finishes: ["Distressed Golden Mango", "Charcoal Shou Sugi Ban"],
    price: "₹38,000",
    image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Hotel rooftop bars, boutique café high-top seating, and modern gastropubs.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["bar", "table", "high top", "industrial", "mango wood"]
  },
  {
    id: "ind-bar-outdoor",
    title: "Goa Beach Club Weatherproof Barstool",
    name: "Goa Beach Club Weatherproof Barstool",
    slug: "goa-beach-club-weatherproof-barstool",
    category: "Bar Furniture",
    subcategory: "Outdoor Bar Furniture",
    description: "An outdoor barstool weaving UV-resistant polyester rope over a powder-coated aluminum frame.",
    story: "Engineered for oceanfront weather. Rust-resistant frame with double-braided grey rope weaving and quick-drying foam cushion.",
    designer: "SB Artisan Atelier",
    materials: ["Powder-coated Aluminum", "UV-resistant Polyester Rope"],
    dimensions: { height: 98, width: 44, depth: 46, unit: "cm" },
    finishes: ["Platinum Grey", "Onyx Black"],
    price: "₹18,500",
    image: "https://images.unsplash.com/photo-1507473885765-e6ed057f782c?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1507473885765-e6ed057f782c?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Hotel outdoor pool bars, oceanfront tiki lounges, and open-air rooftop decks.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["bar", "outdoor", "stool", "rope", "resort", "patio"]
  },
  {
    id: "ind-bar-custom",
    title: "Bespoke Live Edge Suwar Wood Bar Counter",
    name: "Bespoke Live Edge Suwar Wood Bar Counter",
    ...
    story: "The ultimate centerpiece for a luxury hotel bar. Features a highly-figured live edge top protected with contract-grade matte poly coat and optional integrated brass cable grommets.",
    designer: "Jodhpur Woodworking Atelier",
    materials: ["Solid Suwar Wood", "Brass Inserts"],
    dimensions: { height: 110, width: 240, depth: 80, unit: "cm" },
    finishes: ["Natural Suwar Matte Oil", "Dark Walnut Stain"],
    price: "₹1,45,000",
    image: "https://images.unsplash.com/photo-1595428774223-ef52624120d2?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1595428774223-ef52624120d2?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Main hotel lobby cocktail bars, luxury club lounges, and VIP tasting counters.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["bar", "custom", "counter", "suwar wood", "live edge"]
  },
  {
    id: "ind-cafe-bar-stool",
    title: "Monsoon Rattan Bar Stool",
    name: "Monsoon Rattan Bar Stool",
    slug: "monsoon-rattan-bar-stool",
    category: "Cafe Furniture",
    subcategory: "Cafe Chairs",
    description: "A high-profile café bar stool woven from sustainable natural rattan cane.",
    story: "Part of our tropical café line. Handcrafted in Jodhpur, featuring wet-bent steam frames and signature cross-hatched rattan wicker seat wrapping.",
    designer: "SB Artisan Atelier",
    materials: ["Natural Rattan Cane", "Split Wicker"],
    dimensions: { height: 102, width: 45, depth: 45, unit: "cm" },
    finishes: ["Honey Lacquer", "Natural Blonde Wax"],
    price: "₹16,500",
    image: "https://images.unsplash.com/photo-1592078615290-033ee584e267?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1592078615290-033ee584e267?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Resort coffee shops, hotel juice bars, and boutique café counter dining.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["cafe", "barstool", "rattan", "cane", "seating"]
  },
  {
    id: "ind-cafe-bench",
    title: "Artisan Teakwood Cafe Bench",
    name: "Artisan Teakwood Cafe Bench",
    slug: "artisan-teakwood-cafe-bench",
    category: "Cafe Furniture",
    subcategory: "Café Benches",
    description: "A minimalist solid teak dining bench designed for bistro and café group seating.",
    story: "Understated Scandinavian-inspired clean lines met with traditional Indian craftsmanship. Built from kiln-dried grade-A plantation teak.",
    designer: "Jodhpur Woodworking Atelier",
    materials: ["Plantation Teakwood"],
    dimensions: { height: 45, width: 140, depth: 38, unit: "cm" },
    finishes: ["Natural Teak Protective Oil", "Warm Walnut Wax"],
    price: "₹24,000",
    image: "https://images.unsplash.com/photo-1503602642458-232111445657?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1503602642458-232111445657?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Boutique café communal dining tables, coffee shop waiting lines, and outdoor resort patios.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["cafe", "bench", "seating", "teak", "bistro"]
  },
  {
    id: "ind-cafe-outdoor",
    title: "Monsoon Weatherproof Outdoor Cafe Bistro Set",
    name: "Monsoon Weatherproof Outdoor Cafe Bistro Set",
    slug: "monsoon-weatherproof-outdoor-cafe-bistro-set",
    category: "Cafe Furniture",
    subcategory: "Outdoor Café Furniture",
    description: "A lightweight bistro set featuring a weather-treated teak table and 2 woven armchairs.",
    story: "Perfect for outdoor Parisian-style street cafes. Fully weatherproof synthetic rattan wrap on a rust-proof aluminum frame.",
    designer: "SB Artisan Atelier",
    materials: ["Plantation Teakwood", "Synthetic Wicker", "Aluminum Frame"],
    dimensions: { height: 74, width: 70, depth: 70, unit: "cm" },
    finishes: ["Natural Weatherproof Matte Teak Oil"],
    price: "₹45,000",
    image: "https://images.unsplash.com/photo-1592078615290-033ee584e267?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1592078615290-033ee584e267?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Outdoor café patios, bakery sidewalk seating, and hotel terrace dining.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["cafe", "outdoor", "bistro", "set", "teak", "rattan"]
  },
  {
    id: "ind-cane-dining",
    title: "Nilgiri Rattan Cane Dining Chair",
    name: "Nilgiri Rattan Cane Dining Chair",
    slug: "nilgiri-rattan-cane-dining-chair",
    category: "Cane Furniture",
    subcategory: "Cane Dining Chairs",
    description: "A sturdy, hand-woven dining armchair blending grade-A teakwood with natural cane webbing.",
    story: "Part of our tropical resort dining line. Kiln-dried plantation teak frames support premium natural cane back and seat panels.",
    designer: "SB Artisan Atelier",
    materials: ["Plantation Teakwood", "Natural Cane Webbing"],
    dimensions: { height: 85, width: 56, depth: 58, unit: "cm" },
    finishes: ["Natural Teak Finish", "Warm Walnut Wax"],
    price: "₹18,500",
    image: "https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Boutique resort dining salons, upscale hotel breakfast rooms, and private estate patios.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["cane", "chair", "dining", "teak", "seating"]
  },
  {
    id: "ind-cane-sofa",
    title: "Malabar Coastal Cane Sofa Set",
    name: "Malabar Coastal Cane Sofa Set",
    slug: "malabar-coastal-cane-sofa-set",
    category: "Cane Furniture",
    subcategory: "Cane Sofas",
    description: "A premium three-seater living room sofa utilizing organically bent cane framing and soft cotton upholstery.",
    story: "A relaxed coastal seating statement. Built with natural wet-bent cane poles bound with cane peel straps, paired with thick off-white linen cushions.",
    designer: "SB Artisan Atelier",
    materials: ["Steamed Bent Cane", "Premium Cotton Fabric"],
    dimensions: { height: 80, width: 180, depth: 85, unit: "cm" },
    finishes: ["Honey Amber Lacquer"],
    price: "₹54,000",
    image: "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Boutique hotel lobbies, sunrooms, covered terraces, and wellness retreat lounges.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["cane", "sofa", "seating", "resort", "lounge"]
  },
  {
    id: "ind-cane-outdoor",
    title: "Goa Resort Weatherproof Synthetic Cane Armchair",
    name: "Goa Resort Weatherproof Synthetic Cane Armchair",
    slug: "goa-resort-weatherproof-synthetic-cane-armchair",
    category: "Cane Furniture",
    subcategory: "Outdoor Cane Furniture",
    description: "An outdoor armchair combining weather-treated synthetic cane mesh and powder-coated metal frame.",
    story: "Engineered to withstand direct sunlight and salty ocean air. Synthetic rattan peel mesh is wrapped on rust-resistant aluminum framing.",
    designer: "SB Artisan Atelier",
    materials: ["Synthetic Cane", "Powder-coated Aluminum Frame"],
    dimensions: { height: 76, width: 62, depth: 65, unit: "cm" },
    finishes: ["Warm Tan Wicker", "Charcoal Wicker"],
    price: "₹22,000",
    image: "https://images.unsplash.com/photo-1592078615290-033ee584e267?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1592078615290-033ee584e267?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Beach resort poolside lounge areas, hotel balconies, and open-air cocktail terraces.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["cane", "outdoor", "chair", "patio", "resort"]
  },
  {
    id: "ind-bone-sideboard",
    title: "Jodhpur Starry Night Bone Inlay Credenza",
    name: "Jodhpur Starry Night Bone Inlay Credenza",
    slug: "jodhpur-starry-night-bone-inlay-credenza",
    category: "Bone Inlay Furniture",
    subcategory: "Bone Inlay Sideboards",
    description: "A celestial-themed credenza featuring bone inlay motifs set in midnight indigo resin.",
    story: "A majestic centerpiece for dining rooms and grand hallways. Skilled Jodhpur craftsmen inlay natural camel bone in floral pattern clusters against a rich hand-mixed indigo resin base, sealed with clear coat.",
    designer: "Jodhpur Bone Inlay Atelier",
    materials: ["Ethically Sourced Bone", "Indigo Blue Resin", "Mango Wood Core"],
    dimensions: { height: 78, width: 160, depth: 45, unit: "cm" },
    finishes: ["Indigo Blue Resin", "Charcoal Resin"],
    price: "₹1,45,000",
    image: "https://images.unsplash.com/photo-1595428774223-ef52624120d2?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1595428774223-ef52624120d2?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Hotel lobby features, luxury dining rooms, VIP hotel suites.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["bone", "sideboard", "credenza", "inlay", "jodhpur"]
  },
  {
    id: "ind-bone-bedside",
    title: "Jaipur Floral Bone Inlay Bedside Table",
    name: "Jaipur Floral Bone Inlay Bedside Table",
    slug: "jaipur-floral-bone-inlay-bedside-table",
    category: "Bone Inlay Furniture",
    subcategory: "Bone Inlay Bedside Tables",
    description: "An elegant nightstand showing floral bone inlay detailing set in soft grey resin.",
    story: "An enchanting addition to hotel suites or master bedrooms. Handcrafted in Jodhpur, featuring two drawers with bone inlay knobs and a sturdy mango wood frame.",
    designer: "Jaipur Crafts Guild",
    materials: ["Ethically Sourced Bone", "Grey Resin Pigment", "Solid Mango Wood Core"],
    dimensions: { height: 60, width: 50, depth: 40, unit: "cm" },
    finishes: ["Soft Grey Resin", "Jet Black Resin"],
    price: "₹32,000",
    image: "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&w=800&q=80",
    imageGallery: [
      "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&w=800&q=80"
    ],
    hospitalityUsage: "Boutique hotel bedside tables, luxury resort suites, elegant lounge side tables.",
    featured: true,
    isFeatured: true,
    isNew: true,
    tags: ["bone", "nightstand", "bedside", "inlay", "jaipur"]
  }
];
