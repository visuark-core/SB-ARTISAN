...
export default function ProductInfo({
  ...
  return (
    ...
    >
      {/* Category */}
      <span className="block text-[7px] min-[360px]:text-[8px] sm:text-[10px] tracking-[0.2em] font-sans text-[#8C8273] uppercase font-light">
        {category}
      </span>

      {/* Title */}
      <h3 className="font-serif text-[9px] min-[360px]:text-[10px] min-[400px]:text-xs sm:text-sm md:text-lg lg:text-xl font-light text-[#1A1A1A] leading-tight tracking-wide">
        {href ? (
